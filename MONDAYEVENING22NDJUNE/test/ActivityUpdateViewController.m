...
//    NSArray *sortedArray;
    ...
    self.sortedArray =
    [activityType_PickerArr sortedArrayUsingSelector:@selector(localizedCaseInsensitiveCompare:)];
    ...
    // ObjC Fast Enumeration
        //self.sortedArray
    for (NSString *title in self.sortedArray) {
        ...
        switch (popup.tag) {
            ...
            case 1:
                if(buttonIndex == actionSheet.cancelButtonIndex)
                {
                    ...
                    NSLog(@"Button index %ld",(long)buttonIndex);
                    self.txtActivityType.text = NSLocalizedString([self.sortedArray objectAtIndex:buttonIndex],@"");
